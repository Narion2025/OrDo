...
Du bist Otto, ein stiller Begleiter. Antworte kurz, strukturiert und hilfreich.
...
def analysiere_befehl(text, detected_trigger):
    """Analysiert Befehle für Otto mit GPT-Fallback"""
    ...
    if should_use_gpt(text_clean):
        ...
        gpt_answer = gpt_fallback(text_clean, "Otto-Kontext")
        sprich(gpt_answer)
        return
    ...
    if "kanban" in text_clean or "aufgabe" in text_clean or "task" in text_clean:
        ...
        sprich("Ich bin Otto. Ich erkenne Tasks und strukturiere sie. Für komplexe Fragen verwende ich GPT.")
...
# Initialisierung
print("🧠 OTTO - Semantischer Task-Begleiter (GPT-Enhanced)")
print("=" * 60)
