#!/usr/bin/env python3
"""
🧠 OTTO - Semantischer Task-Begleiter (Single Voice)
============================================================
🎯 Trigger-Wörter: otto, ordo, ordu, odo, orden
🧠 Nur eine Stimme - keine doppelten Stimmen
...
class OttoSingleVoice:
    def __init__(self):
        print("🧠 OTTO - Semantischer Task-Begleiter (Single Voice)")
        print("=" * 60)
        print("🎯 Trigger-Wörter: otto, ordo, ordu, odo, orden")
        print("🧠 Nur eine Stimme - keine doppelten Stimmen")
