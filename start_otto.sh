...
echo "🧠 OTTO - Semantischer Task-Begleiter (GPT-Enhanced)"
echo "=================================================="
echo ""
...
if [ ! -f "ordo_voice_agent_otto.py" ]; then
    echo "❌ ordo_voice_agent_otto.py nicht gefunden!"
    exit 1
fi
...
echo "🚀 Starte Otto mit GPT-Integration..."
...
# Starte Otto
python3 ordo_voice_agent_otto.py 